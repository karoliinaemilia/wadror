...
describe "Beerlist page" do
  ...
  it "shows beers in alphabetical order by style if style is clicked", :js => true do
    visit beerlist_path
    click_link "style"
  ...
  it "shows beers in alphabetical order by brewery if brewery is clicked", :js => true do
    visit beerlist_path
    click_link "brewery"
